    ...
    constructor(project: Project) {
        ...
        this.projectAbridgement.innerHTML = `
            <div class="space-between-flex">
                <span class="recruitPeriod">${toDateString(this.project.recruitStartDate)} ~ ${toDateString(this.project.recruitEndDate)}</span>
                <div class="state ${this.project.recruitState? "running" : ""}">${this.project.recruitState? "모집중" : "모집종료"}</div>
            </div>
            <span class="title">${this.project.title}</span>
            <span class="contents">${this.project.contents}</span>
            <div class="line"></div>
            <div class="space-between-flex">
                <div class="center-flex">
                    <span class="bold">현재 인원</span>
                    <span>${toSummaryNumber(this.project.currentMember)}명</span>
                </div>
                <div class="center-flex">
                    <span class="bold">추가 모집</span>
                    <span>${toSummaryNumber(this.project.additionalRecruitMember)}명</span>
                </div>
            </div>
            <div>
                <span class="bold">사용 기술 스택</span>
            ...
            <div class="info-container">
                <div class="info">
                    <svg class="x3" viewBox="0 0 24 24">
                    ...
                    <span>${toSummaryNumber(this.project.watchCount)}</span>
                </div>
                <div class="info">
                    <svg class="x3" viewBox="0 0 24 24">
                    ...
                    <span>${toSummaryNumber(this.project.goodCount)}</span>
                </div>
                <div class="info">
                    <svg class="x3" viewBox="0 0 24 24">
                    ...
                    <span>${toSummaryNumber(this.project.mentionCount)}</span>
                </div>
            </div>`;
    }
