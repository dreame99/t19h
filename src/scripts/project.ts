        ...
        this.projectAbridgement.innerHTML = `
            ...
            <div style="display: flex; justify-content: flex-end; flex-wrap: wrap; gap: 20px;">
                <div style="display: flex; align-items: center; gap: 8px;">
                    ...
                    <span style="overflow-wrap: anywhere;">${toSummaryNumber(this.project.watchCount)}</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px;">
                    <svg width="24" height="24">
                    ...
                    <span style="overflow-wrap: anywhere;">${toSummaryNumber(this.project.goodCount)}</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px;">
                    <svg width="24" height="24">
                    ...
                    <span style="overflow-wrap: anywhere;">${toSummaryNumber(this.project.mentionCount)}</span>
                </div>
            </div>`;
    }
