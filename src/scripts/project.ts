    ...
    constructor(project: Project) {
        ...
        this.projectAbridgement.innerHTML = `
            <div class="space-between-flex">
                <span class="recruitPeriod">${toDateString(this.project.teamRecruitmentStartDate)} ~ ${toDateString(this.project.teamRecruitmentEndDate)}</span>
            ...
            <span class="contents">${this.project.content}</span>
            <div class="line"></div>
            <div class="space-between-flex">
                ...
                <div class="center-flex">
                    ...
                    <span>${toSummaryNumber(this.project.personnel)}명</span>
                </div>
            </div>
            <div>
            ...
            <div class="info-container">
                <div class="info">
                    ...
                    <span>${toSummaryNumber(this.project.countViews)}</span>
                </div>
                <div class="info">
                    <svg class="x3" viewBox="0 0 24 24">
                    ...
                    <span>${toSummaryNumber(this.project.countGreats)}</span>
                </div>
                <div class="info">
                    <svg class="x3" viewBox="0 0 24 24">
